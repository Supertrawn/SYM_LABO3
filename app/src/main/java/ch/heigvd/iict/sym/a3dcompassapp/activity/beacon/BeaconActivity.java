...
public class BeaconActivity extends AppCompatActivity implements BeaconConsumer {
    ...
    private class BeaconListViewAdaptater extends ArrayAdapter<Beacon> {
        ...
        public BeaconListViewAdaptater(Context context, List<Beacon> beacons) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(viewHolder == null){
                ...
                viewHolder.minNumber = (TextView) convertView.findViewById(R.id.minNumber);
                viewHolder.majNumber = (TextView) convertView.findViewById(R.id.majNumber);
